#!/bin/bash
  ...
  sudo curl -o terraform_1.3.7_linux_amd64.zip https://releases.hashicorp.com/terraform/1.3.7/terraform_1.3.7_linux_amd64.zip
  sudo unzip -o terraform_1.3.7_linux_amd64.zip -d /bin
